...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dangerousStyleValue = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _preactRouter = __webpack_require__(28);
	...
	var _onetime = __webpack_require__(11);
	...
	var App = function (_Component) {
	  ...
	  App.prototype.render = function render() {
	    return (0, _preact.h)(
	      'div',
	      { 'class': 'app', style: style },
	      (0, _preact.h)(
	        _preactRouter.Router,
	        { onChange: this.handleRoute },
	        (0, _preact.h)(_home2.default, { path: '/' }),
	        (0, _preact.h)(_onetime2.default, { path: '/onetime' })
	      )
	    );
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function (_Component) {
		...
		Footer.prototype.goToTwitter = function goToTwitter() {
			window.location.assign('https://www.twitter.com/jeremiecorpinot');
		};
	
		Footer.prototype.goToMedium = function goToMedium() {
			window.location.assign('https://medium.com/@jeremiecorpinot');
		};
	
		Footer.prototype.goToInstagram = function goToInstagram() {
		...
		Footer.prototype.render = function render() {
			...
			return (0, _preact.h)(
				...
				(0, _preact.h)(
					'div',
					iconContainerStyle,
					(0, _preact.h)('div', _extends({}, (0, _glamor.css)(twitterIcon, iconStyle), {
						onClick: function onClick() {
							return _this2.goToTwitter();
						} })),
					(0, _preact.h)('div', _extends({}, (0, _glamor.css)(mediumIcon, iconStyle), {
						onClick: function onClick() {
							return _this2.goToMedium();
						} })),
					(0, _preact.h)('div', _extends({}, (0, _glamor.css)(instagramIcon, iconStyle), {
						onClick: function onClick(vt) {
							return _this2.goToInstagram();
						} }))
				)
			);
		};
	...
	var footerStyle = (0, _glamor.css)({
		height: '200px',
		background: '#282830',
		color: 'white'
	});
	
	var iconContainerStyle = (0, _glamor.css)({
		width: '300px',
		margin: 'auto',
		top: '50px',
		position: 'relative'
	...
	var instagramIcon = (0, _glamor.css)({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = function (_Component) {
	  ...
	  Home.prototype.getHeroStyle = function getHeroStyle() {
	    return (0, _glamor.css)({
	      width: '100%',
	      position: 'relative',
	      background: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(' + this.state.imgUrl + ')',
	      backgroundSize: 'cover',
	      height: '100vh'
	    });
	  };
	
	  Home.prototype.request = function request(arg) {
	  ...
	  Home.prototype.componentWillMount = function componentWillMount() {
	    ...
	    this.request({
	      ...
	      success: function success(response) {
	        ...
	        _this2.setState({ imgUrl: picture.urls.regular });
	      }
	    });
	  ...
	  Home.prototype.addParallax = function addParallax() {
	    var _this3 = this;
	
	    window.addEventListener('scroll', function (e) {
	      var topDistance = _this3.title.getBoundingClientRect().top;
	      var depth = 0.20;
	      var movement = topDistance * depth;
	      var movement2 = topDistance * 0.20;
	
	      var translate3d = 'translate3d(0, ' + movement + 'px, 0)';
	      var trans3d = 'translate3d(0, ' + movement2 + 'px, 0)';
	
	      _this3.title.style.transform = translate3d;
	      _this3.iconTwitter.style.transform = translate3d;
	    });
	  };
	
	  Home.prototype.shareTweet = function shareTweet() {
	    var url = 'https://twitter.com/intent/tweet?text=' + this.state.quoteContent + ' - de ' + this.state.quoteAuthor + ' - ' + this.state.quoteRef + '&hashtags=citation,quote';
	    window.open(url);
	  };
	    ...
	    return (0, _preact.h)(
	      ...
	      (0, _preact.h)(
	        ...
	        (0, _preact.h)(
	          ...
	          (0, _preact.h)(
	            'div',
	            _extends({}, heroTitleStyle, { ref: function ref(title) {
	                _this4.title = title;
	              } }),
	            (0, _preact.h)(
	              'h1',
	          ...
	          (0, _preact.h)(
	            ...
	            (0, _preact.h)(
	              'div',
	              quoteIconStyle,
	              (0, _preact.h)('span', _extends({}, (0, _glamor.css)(twitterIcon, iconStyle), {
	                onClick: function onClick() {
	                  return _this4.shareTweet();
	                } }))
	            )
	          )
	        )
	      ),
	      (0, _preact.h)(_projects2.default, null),
	...
	var textBlockStyle = (0, _glamor.css)({
	  top: '50%',
	  left: '50%',
	  position: 'absolute',
	  textAlign: 'center',
	...
	var heroTitleStyle = (0, _glamor.css)({
	  cursor: 'pointer',
	...
	var quoteIconStyle = (0, _glamor.css)({
	  textAlign: 'right'
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var puzzleIcon = __webpack_require__(20);
	var arrowpuzzleIcon = __webpack_require__(19);
	...
	var Projects = function (_Component) {
	  ...
	  Projects.prototype.request = function request(arg) {
	    var req = new XMLHttpRequest();
	    req.open(arg.method, arg.url, true);
	    req.setRequestHeader('Content-Type', 'application/json;charset=UTF-8');
	    req.onreadystatechange = function () {
	  ...
	  Projects.prototype.componentDidMount = function componentDidMount() {
	    ...
	    this.request({
	      ...
	      success: function success(response) {
	        ...
	        _this2.setState({ projects: projects, count: projects.length });
	      }
	    });
	  };
	
	  Projects.prototype.getContainerStyle = function getContainerStyle() {};
	
	  Projects.prototype.scrollLeft = function scrollLeft() {
	    var _this3 = this;
	
	    for (var i = 0; i < 200; i++) {
	      setTimeout(function () {
	        _this3.projectsList.scrollLeft -= 2;
	      }, i);
	    }
	  };
	
	  Projects.prototype.scrollRight = function scrollRight() {
	    var _this4 = this;
	
	    for (var i = 0; i < 200; i++) {
	      setTimeout(function () {
	        _this4.projectsList.scrollLeft += 2;
	      }, i);
	    }
	  };
	
	  Projects.prototype.toggleProject = function toggleProject(project) {};
	    ...
	    return (0, _preact.h)(
	      ...
	      (0, _preact.h)(
	        ...
	        (0, _preact.h)(
	          ...
	          (0, _preact.h)(
	            'a',
	            { href: 'https://github.com/rootasjey?tab=repositories' },
	            'PROJECTS'
	          )
	        ),
	        (0, _preact.h)(
	        ...
	        (0, _preact.h)('img', _extends({}, arrowLeftStyle, { src: arrowpuzzleIcon, onClick: function onClick() {
	            return _this5.scrollLeft();
	          } })),
	        (0, _preact.h)('img', _extends({}, arrowRightStyle, { src: arrowpuzzleIcon, onClick: function onClick() {
	            return _this5.scrollRight();
	          } }))
	      ),
	      (0, _preact.h)(
	        'div',
	        _extends({}, listStyle, { ref: function ref(projectsList) {
	            _this5.projectsList = projectsList;
	          } }),
	        this.state.projects.map(function (project) {
	          return (0, _preact.h)(
	            'div',
	            bubbleStyle,
	            (0, _preact.h)('div', bubbleBackgroundStyle),
	            (0, _preact.h)(
	              'div',
	              bubbleTextStyle,
	              ' ',
	            ...
	            (0, _preact.h)('img', _extends({ src: puzzleIcon }, bubbleIconStyle))
	          );
	        })
	      )
	    );
	...
	var countStyle = (0, _glamor.css)({
	  marginTop: '-20px',
	  marginBottom: '-20px',
	  fontSize: '4em'
	});
	
	var arrowRightStyle = (0, _glamor.css)({
	  height: '40',
	  width: '40',
	...
	var arrowLeftStyle = (0, _glamor.css)({
	  height: '40',
	  width: '40',
	...
	var bubbleBackgroundStyle = (0, _glamor.css)({
	  height: '60%',
	  width: '60%',
	  borderRadius: '60%',
	  margin: 'auto',
	...
	var bubbleTextStyle = (0, _glamor.css)({
	  // top: '50px',
	...
	var bubbleIconStyle = (0, _glamor.css)({
	  height: '40%',
	  width: '40%',
	...
	var moreButtonStyle = (0, _glamor.css)({
	  height: '10px',
	  width: '60px',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Onetime = function (_Component) {
	  _inherits(Onetime, _Component);
	
	  function Onetime() {
	    var _temp, _this, _ret;
	
	    _classCallCheck(this, Onetime);
	  ...
	  Onetime.prototype.request = function request(arg) {
	    var req = new XMLHttpRequest();
	  ...
	  Onetime.prototype.componentDidMount = function componentDidMount() {
	    console.log('mounted!');
	    this.watch();
	  };
	
	  Onetime.prototype.watch = function watch() {
	    var url = 'http://prod.websivik.keolis.com/sivik/rest/SiriWSLite24/stop-monitoring.json?LineRef=004_DEVILLAIRS:Line::24:LOC&MinimumStopVisitsPerLineVia=2&MonitoringRef=STIF:StopArea:SP:52243:&PreviewInterval=120&RequestorRef=WEBIVTR_PHEBUS&StopVisitTypes=departures';
	    this.request({
	      url: url,
	      success: function success(resp, req) {
	        console.log(resp);
	      },
	      failure: function failure(resp, req) {}
	    });
	  };
	
	  Onetime.prototype.render = function render() {
	    return (0, _preact.h)(
	      'div',
	      null,
	      (0, _preact.h)(
	  ...
	  (function () {
	    ...
	    console.log = function (t) {
	      ...
	      if (typeof t === 'string' && t.match(/^\[(HMR|WDS)\]/)) {
	        if (t.match(/(up to date|err)/i)) logs.push.apply(logs, [t.replace(/^.*?\]\s*/m, '')].concat(args));
	      } else {
	        log.call.apply(log, [console, t].concat(args));
	      }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "cc62e354030da74298e2d82865debcfe.png";

/***/ },
/* 20 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "1523f33c9c2c51360e93a107ba7d0a15.png";
